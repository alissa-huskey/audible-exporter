...
describe("Exporter", () => {
  ...
  test(".getResults()", async () => {
    ...
    exporter.library.books = [
      { id: "B0CQ3759C3", url: "/pd/Wind-and-Truth-Audiobook/B0CQ3759C3", title: "Wind and Truth: Book Five of the Stormlight Archive", authors: ["Brandon Sanderson"], narrator: "Kate Reading", series: "The Stormlight Archive" },
      { id: "B0BG96TCVH", url: "/pd/Demons-of-Good-and-Evil-Audiobook/B0BG96TCVH", title: "Demons of Good and Evil: Hollows, Book 17", authors: ["Kim Harrison"], narrator: "Marguerite Gavin", series: "The Hollows" },
      { id: "1713569264", url: "/pd/The-Queen-Audiobook/1713569264", title: "The Queen: A Wicked Novella (1001 Dark Nights)", authors: ["Jennifer L. Armentrout"], narrator: "Amy Landon", series: "Wicked Saga" },
    ];
