    ...
    "build/util.js"() {
      ...
      cleanObject = function(ob) {
        return Object.entries(ob).reduce((r, [k, v]) => {
          if (v != null && v != void 0 && v !== "" && (typeof v == "boolean" || typeof v == "string" || typeof v == "symbol" || typeof v == "number" || typeof v == "function" || typeof v == "object" && (Array.isArray(v) && v.length || Array.isArray(v) != true))) {
            r[k] = v;
            return r;
          } else {
            return r;
  ...
  var require_timer = __commonJS({
    "build/timer.js"() {
      ...
      Timer = class {
        ...
        stop() {
          this.stopped_at = /* @__PURE__ */ new Date();
        ...
        data() {
          ...
          for (let i in this._fields) {
            try {
              ...
              let identifiers = this._identifers.map((i2) => `${i2}: ${this[i2]}`).join(", ");
...
`, err);
  ...
  // build/library-book-row.js
  var require_library_book_row = __commonJS({
    "build/library-book-row.js"() {
      require_util();
      require_parser();
      LibraryBookRow = class extends Parser {
        ...
        get url() {
          return this.ul.gcf("bc-size-headline3").parentElement.attributes["href"]?.value.replace(/\?.+/, "");
        }
        get title() {
...
`, err);
  ...
  // build/library-page.js
  var require_library_page = __commonJS({
    "build/library-page.js"() {
      require_library_book_row();
      require_page();
  ...
  // build/library-fetcher.js
  var require_library_fetcher = __commonJS({
    "build/library-fetcher.js"() {
      require_util();
      require_timer();
      require_library_page();
  ...
  // build/book-page.js
  var require_book_page = __commonJS({
    "build/book-page.js"() {
      require_util();
      require_page();
      BookPage = class extends Page {
        ...
        get date() {
          ...
          if (!date) return null;
          return /* @__PURE__ */ new Date(`${date}:00:00:01`);
        }
        get release_date() {
        ...
        get category_type() {
          ...
          for (let genre2 of this.#category_types) {
            if (all.some((c) => {
              return c.toLowerCase().includes(genre2.toLowerCase());
            })) {
              return genre2.toLowerCase();
            }
          }
      ...
      NormalBookPage = class extends BookPage {
        ...
        get categories_list() {
          return this.doc.qs(".categoriesLabel a")?.map((c) => {
  ...
  // build/details-fetcher.js
  var require_details_fetcher = __commonJS({
    "build/details-fetcher.js"() {
      require_util();
      require_timer();
      require_book_page();
  ...
  // build/order-row.js
  var require_order_row = __commonJS({
    "build/order-row.js"() {
      require_util();
      require_parser();
  ...
  // build/order-page.js
  var require_order_page = __commonJS({
    "build/order-page.js"() {
      require_util();
      require_page();
      require_order_row();
  ...
  // build/orders-fetcher.js
  var require_orders_fetcher = __commonJS({
    "build/orders-fetcher.js"() {
      require_util();
      require_timer();
      require_order_page();
      OrdersFetcher = class {
        ...
        async init(limit) {
          ...
          for (let year of this.years) {
            ...
            let page_count;
            do {
              let page2 = new OrderPage(tryInt(year), page_num);
              if (page_num == 1) {
                await page2.get();
                page_count = page2.page_count;
              }
...
@-webkit-keyframes pulse {
      ...
      Modal = class extends Styled {
        ...
        get wrapper() {
          if (!this.#wrapper) {
            ...
            wrapper.style["z-index"] = (/* @__PURE__ */ new Date()).getTime();
  ...
  // build/start-modal.js
  var require_start_modal = __commonJS({
    "build/start-modal.js"() {
      require_util();
      require_modal();
  ...
  // build/download-modal.js
  var require_download_modal = __commonJS({
    "build/download-modal.js"() {
      require_util();
      require_modal();
  ...
  // build/status-notifier.js
  var require_status_notifier = __commonJS({
    "build/status-notifier.js"() {
      require_timer();
      require_styled();
      StatusNotifier = class extends Styled {
          ...
          if (!this.#wrapper) {
            this.#wrapper = Doc.create("div", {
              ...
              style: {
                ...
                "z-index": (/* @__PURE__ */ new Date()).getTime()
              }
            });
         ...
         */
        get minutes_left() {
          let minutes = (this.ms_left / 1e3 / 60).toFixed(1);
  ...
  // build/purchase-history-notifier.js
  var require_purchase_history_notifier = __commonJS({
    "build/purchase-history-notifier.js"() {
      require_util();
      require_status_notifier();
  ...
  // build/order-notifier.js
  var require_order_notifier = __commonJS({
    "build/order-notifier.js"() {
      require_util();
      require_status_notifier();
  ...
  // build/library-notifier.js
  var require_library_notifier = __commonJS({
    "build/library-notifier.js"() {
      require_util();
      require_status_notifier();
  ...
  // build/details-notifier.js
  var require_details_notifier = __commonJS({
    "build/details-notifier.js"() {
      require_util();
      require_status_notifier();
  ...
  // build/virtual-file.js
  var require_virtual_file = __commonJS({
    "build/virtual-file.js"() {
      require_util();
      VirtualFile = class {
        #contents = null;
  ...
  // build/json-file.js
  var require_json_file = __commonJS({
    "build/json-file.js"() {
      require_util();
      require_virtual_file();
  ...
  // build/tsv-file.js
  var require_tsv_file = __commonJS({
    "build/tsv-file.js"() {
      require_util();
      require_virtual_file();
      TSVFile = class extends VirtualFile {
        ...
        get rows() {
          if (!this.records || isEmpty(this.records)) return null;
          if (!this.#rows) {
            this.#rows = this.records.map(
              (row) => Object.values(row).map((v) => this.sanitize(v))
            );
          }
          return this.#rows;
        }
  ...
  require_util();
  require_timer();
  require_library_fetcher();
  require_details_fetcher();
  require_orders_fetcher();
  require_start_modal();
  require_download_modal();
  require_purchase_history_notifier();
  require_order_notifier();
  require_library_notifier();
  require_details_notifier();
  require_json_file();
  require_tsv_file();
  require_result();
  download = () => {
  ...
  Exporter = class {
    ...
    getResults() {
      let library_info, order_info, book_info, info2;
      let results = [];
